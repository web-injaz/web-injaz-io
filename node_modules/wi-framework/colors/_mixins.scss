...
@mixin create-background($name, $bg, $colors: false, $varPrefix: '') {
    ...
    // @debug '#{$name}: #{contrast-pers($bg)}, lightness: #{round(lightness($bg))}';
    .bg-#{$name} {
        --background: #{$bg};
        @include mapItemCheck($bg, $colors, 'text', $prefix: $varPrefix);
        @include mapItemCheck($bg, $colors, 'main', $prefix: $varPrefix);
        @include mapItemCheck($bg, $colors, 'second', $prefix: $varPrefix);
        ...
        @if $enable-darken {
            ...
            @include mapItemCheck($bg, $colors, 'darken-40', $prefix: $varPrefix);
            @include mapItemCheck($bg, $colors, 'darken-50', $prefix: $varPrefix);
            @include mapItemCheck($bg, $colors, 'darken-60', $prefix: $varPrefix);
            @include mapItemCheck($bg, $colors, 'darken-70', $prefix: $varPrefix);
            @include mapItemCheck($bg, $colors, 'darken-80', $prefix: $varPrefix);
            @include mapItemCheck($bg, $colors, 'darken-90', $prefix: $varPrefix);
        }
        @if $enable-lighten {
            ...
            @include mapItemCheck($bg, $colors, 'lighten-40', $prefix: $varPrefix);
            @include mapItemCheck($bg, $colors, 'lighten-50', $prefix: $varPrefix);
            @include mapItemCheck($bg, $colors, 'lighten-60', $prefix: $varPrefix);
            @include mapItemCheck($bg, $colors, 'lighten-70', $prefix: $varPrefix);
            @include mapItemCheck($bg, $colors, 'lighten-80', $prefix: $varPrefix);
            @include mapItemCheck($bg, $colors, 'lighten-90', $prefix: $varPrefix);
        }
        @if $enable-contrast {
            @include mapItemCheck($bg, $colors, 'contrast', $prefix: $varPrefix);
